function boundaries = computeBoundaries(~, F)
...
%   OUTPUT PARAMETERS:
%
%       - boundaries:   #Bx1 cell array of boundary components.
%                       boundaries{i} is a #BVx1 row vector of the vertex
...
if (size(boundaries,2) ~= 1), boundaries = boundaries.'; end
